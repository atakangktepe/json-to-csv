    ...
    if (csvHeadEachDone) {
      ...
      for (var obj of dataArr) {
        ...
        for (var key of csvHeader) {
          ...
          // If string contais comma, take this into double quotes
          obj[key] = (String(obj[key]).indexOf(",") > -1) ? '"'+ obj[key] +'"' : obj[key];

          // Push into a string the values and if line is ending, seperate with comma
      ...
      // Set full csv as string
      fullCsv = csvHeader + "\n" + csvValues;

    }
  });

  callback(null, fullCsv);
}
